  ...
  return (
    <div className="space-y-6">
      <Card className="space-y-4 rounded-2xl border border-red-200 bg-red-50">
        <CardTitle className="text-red-900">Manager Dashboard Error</CardTitle>
        <CardDescription className="text-red-800">
          We encountered an error while loading your manager dashboard. This might be a temporary issue.
        </CardDescription>
