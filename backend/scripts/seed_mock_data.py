...
USERS = [
    {
        ...
        "google_id": "seed-admin-1",
        "email": "admin@acmepms.com",
        "name": "Arjun Mehta",
        "role": UserRole.admin,
        "manager_id": None,
    ...
    async with AsyncSessionLocal() as db:
        ...
        await _insert_if_missing(
            ...
            UUID("44444444-4444-4444-4444-444444444441"),
            {
                ...
                "progress": 82,
                "blockers": None,
                "next_steps": "Continue query tuning and benchmark validation.",
            },
        )
        await _insert_if_missing(
            db,
            ...
            {
                "goal_id": UUID("33333333-3333-3333-3333-333333333332"),
                "employee_id": UUID("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa5"),
                "manager_id": UUID("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa3"),
                ...
                "progress": 76,
                "blockers": None,
                "next_steps": "Add regression scenarios for service boundaries.",
            },
        )
        await _insert_if_missing(
            db,
            ...
            UUID("44444444-4444-4444-4444-444444444443"),
            {
                ...
                "next_steps": "Follow up with stakeholders and finalize commitments.",
            },
        )
