...
from app.routers import auth, users, organizations, goals, checkins, ratings, reviews, ai_router, meetings_router, hr, employees, performance_cycles, dashboard, manager, employee_dashboard, employee_legacy_dashboard, leadership, framework, notifications, reports, goal_cascade, forms, compat
...
app.include_router(employee_legacy_dashboard.router, prefix=settings.API_PREFIX)
app.include_router(leadership.router, prefix=settings.API_PREFIX)
app.include_router(framework.router, prefix=settings.API_PREFIX)
app.include_router(notifications.router, prefix=settings.API_PREFIX)
app.include_router(reports.router, prefix=settings.API_PREFIX)
app.include_router(goal_cascade.router, prefix=settings.API_PREFIX)
